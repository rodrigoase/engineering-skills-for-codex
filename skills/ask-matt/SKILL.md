---
name: ask-matt
description: Use when choosing which installed engineering skill or workflow best fits the current situation.
---
...
- **A merge or rebase is conflicted** → **`$resolving-merge-conflicts`**. Trace both sides to their primary intent, preserve the compatible parts of each change, verify the result, and finish the in-progress Git operation.
